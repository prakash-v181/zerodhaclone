...
All rights reserved.</p>
                ...
                <div className='col' style={{textDecoration:"none"}}>
                    <p>Company</p>
                    <a href=''style={{textDecoration:"none"}}>About</a><b/>
                    <a href=''  style={{textDecoration:"none"}}>Philosophy</a><b/>
                    <a href=''  style={{textDecoration:"none"}}>Press & media</a><b/>
                    <a href='' style={{textDecoration:"none"}}>Careers</a><b/>
                    <a href=''  style={{textDecoration:"none"}}>Zerodha Cares (CSR)</a><b/>
                    <a href=''  style={{textDecoration:"none"}}>Zerodha.tech</a><b/>
                    <a href=''  style={{textDecoration:"none"}}>Open source</a><b/>
                </div>
